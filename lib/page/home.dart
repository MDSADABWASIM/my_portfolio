...
//        _buildNavigationArrows(),
  ...
  Widget _buildEducationSummary() {
    return Text(
      'I totally focus on the basics and maths behind every ML algorithm, because my believe is you can only build as high up as your foundation is deep.',
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/md-sadab-wasim-914a45109/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://medium.com/@sadabwasim", "Medium");
          },
          child: Image.network(
            Assets.evernote,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/mdsadabwasim", "Github");
          },
          child: Image.network(
            Assets.google,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://twitter.com/sadab_wasim", "Twitter");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
